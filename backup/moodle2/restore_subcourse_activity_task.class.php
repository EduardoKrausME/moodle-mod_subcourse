...
/**
 * Provides {@see restore_subcourse_activity_task} class.
 *
...
class restore_subcourse_activity_task extends restore_activity_task {
    ...
    public static function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('subcourse', 'view', 'view.php?id={course_module}', '{subcourse}');
        $rules[] = new restore_log_rule('subcourse', 'fetch', 'view.php?id={course_module}', '{subcourse}');
